This app gets the top HackerNews article once a day and writes a 500-word blog post about it using ChatGPT. The articles are stored in S3 and published on this Python web app.
